...
score=0
# Create a variable 'over' and assign the value "False" to it --- Student 1
...
# Create a font of type 'freesansbold.ttf' in size '30' and naming it 'gameover_font' --- Student 2
...
while True:
  ...
  for enemy in enemies:
      ...
      # Check if 'enemy' collides with the 'player' --- Student 1
     
          # Assign the value "True" to 'over'--- Student 1
          
          # Assign the 'enemy_image' to the 'player_image' --- Student 1
  ...
  # Check if the value of 'over' is "True" --- Student 1
      ...
      # Display the 'gameover_Text' at the location (100,250) --- Student 2
